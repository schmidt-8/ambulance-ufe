...
import { SschAmbulanceWlEditor } from '../ssch-ambulance-wl-editor';
 ...
 afterEach(() => { mock.reset(); });
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [SschAmbulanceWlEditor],
      html: `<ssch-ambulance-wl-editor entry-id="test-entry"
  ...
  it('first text field is patient name', async () => {
    ...
    const page = await newSpecPage({
       components: [SschAmbulanceWlEditor],
       html: `<ssch-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></ssch-ambulance-wl-editor>`,
    });
    await delay(300);
    await page.waitForChanges();
